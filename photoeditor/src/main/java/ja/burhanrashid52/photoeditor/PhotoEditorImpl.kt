...
internal class PhotoEditorImpl @SuppressLint("ClickableViewAccessibility") constructor(
    ...
    override fun addText(text: String, styleBuilder: TextStyleBuilder?) {
        ...
        val multiTouchListener: MultiTouchListener = getMultiTouchListener(isTextPinchScalable)
        val textGraphic: Text = Text(
            photoEditorView,
            multiTouchListener,
            viewState,
        ...
        selectedRootView = textGraphic.rootView
        Log.i("selectedViewLogs", "addText: rootView: ${textGraphic.rootView} ")
    }
